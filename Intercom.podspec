Pod::Spec.new do |s|
  ...
  s.authors             = {"Brian Boyle"=>"brian.boyle@intercom.io", "Dale Cantwell"=>"dale@intercom.io", "Naren Hazareesingh"=>"narendra.hazareesingh@intercom.io", "Mike McNamara"=>"mike.mcnamara@intercom.io"}
