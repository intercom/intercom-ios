//
//  ITCTableViewDataSourceWithIntercomSessionLoading.m
//  SDKSample
//
...
@interface ITCTableViewDataSourceWithIntercomSessionLoading ()
@property (nonatomic, strong) NSDictionary *dataSourceItems;
@end

@implementation ITCTableViewDataSourceWithIntercomSessionLoading
...
- (id)init
{
    ...
    if (self) {
        ...
        self.dataSourceItems = @{
                                 @(ITCCellTypeLoadingSessionOngoing): @"Connecting to Intercom...",
                                 };
    }
    return self;
}
